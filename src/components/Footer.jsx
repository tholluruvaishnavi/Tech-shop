  ...
  return (
    <div>
      <footer className="bg-black">
        <div className="text-white max-w-screen-l px-4 mx-auto py-8">

          <div className="grid grid-cols-1 md:grid-cols-4 gap-20">
            <div>
              <h2 className="text-2xl font-bold">Tech-Shop</h2>
              <p className="mt-4 text-sm text-gray-500">
                Subscribe to our Email alert to receive early discount offers,
              ...
              <form className="mt-4">
                <input
                  ...
                  className="w-full px-3 py-2 rounded text-white border"
                />
                <button className="bg-red-500 mt-3 px-4 py-2 rounded cursor-pointer w-full">
                  Subscribe
                </button>
              </form>
            </div>
            ...
            <div>
              ...
              <ul className="text-gray-500 mt-4 space-y-4 text-sm">
                ...
                <li className="hover:text-red-500">Return Order</li>
                <li className="hover:text-red-500">Warranty Info</li>
              </ul>
            </div>

            <div>
              <p className="px-8 font-medium">Policies</p>
              <ul className="text-gray-500 mt-4 space-y-4 text-sm">
                <li className="hover:text-red-500">Return Policy</li>
                <li className="hover:text-red-500">Security</li>
                <li className="hover:text-red-500">Sitemap</li>
            ...
            <div>
              ...
              <ul className="text-gray-500 mt-4 space-y-4 text-sm">
                ...
                <li className="hover:text-red-500">Affiliates</li>
              </ul>
            </div>
          </div>
